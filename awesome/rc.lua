...
mytextclock = wibox.widget.textclock("<span font='Noto Sans Mono 7'>%b %d %Y (%a) %I:%M</span>")
mytextclock.spacing = 15
...
beautiful.wallpaper = os.getenv("HOME") .. "/.config/awesome/themes/wall.jpg"
...
volume_widget = volumecfg.widget
-- }}}
...
for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        ...
        -- (odina) Another way to "View tag only."
...
awful.rules.rules = {
    ...
    -- (odina) Transparency for terminator
